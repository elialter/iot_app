...
class LiteRollingSwitch extends StatefulWidget {
  ...
  //static _RollingSwitchState of(BuildContext context) => context.findAncestorStateOfType<_RollingSwitchState>();
...
class _RollingSwitchState extends State<LiteRollingSwitch>
  ...
  void initState() {
    ...
    CoverController _controller = widget.controller;
    if (_controller != null) {
      _controller.changeSwitch = changeState;
    }
  }

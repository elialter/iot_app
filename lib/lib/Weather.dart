  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        ...
        Text('${weather.temp.round().toString()}°C',  style: new TextStyle(color: Colors.black)),
        Image.network('https://openweathermap.org/img/w/${weather.icon}.png', width: 70, height: 70,),
